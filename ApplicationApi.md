   ...
   "schemas":{
      "AddressDto":{
         ...
         "properties":{
            ...
            "country_code":{
               "type":"string",
               "description":"ISO country code(ISO 3166-1 alpha-2) see https://www.iso.org/iso-3166-country-codes.html.",
               "example":"DE"
            }
         },
...
| rejection_reasons | string[]  | List of rejections <br>see [rejection reasons](CommonErrors.md#tb-rejection) | `[COMPANY_TOO_YOUNG]`                                              |
